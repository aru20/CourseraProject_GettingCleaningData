...
+ t suffix indicates time
+ f suffix indicated frequency
...
9. The tidy_data.txt in this repository was created by running the run_analysis.R script      using R version 3.2.2 (2015-08-14) on Windows 8.1 64-bit edition.
